...
testUp = TestCase(assertEqual "up" [Board.Pos 9 10, Board.Pos 19 20] (Board.up [Board.Pos 11 10, Board.Pos 21 20]))
...
testCheck1 = TestCase(assertEqual "check1" True (Board.check [Board.Pos 30 1](Board.Pos 30 16)(Board.Pos 40 34)))
testCheck2 = TestCase(assertEqual "check2" False (Board.check [Board.Pos 30 23](Board.Pos 30 16)(Board.Pos 40 34)))
